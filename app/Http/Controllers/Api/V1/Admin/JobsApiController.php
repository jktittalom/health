...
class JobsApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new JobResource(Job::with(['user', 'skills', 'profile', 'facilities', 'experiences'])->get());
    }
    ...
    public function show(Job $job)
    {
        ...
        return new JobResource($job->load(['user', 'skills', 'profile', 'facilities', 'experiences']));
    }
