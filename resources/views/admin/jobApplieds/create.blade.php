...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jobApplied.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-applieds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('applied_date_time') ? 'is-invalid' : '' }}" type="text" name="applied_date_time" id="applied_date_time" value="{{ old('applied_date_time') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('contract_end_time') ? 'is-invalid' : '' }}" type="text" name="contract_end_time" id="contract_end_time" value="{{ old('contract_end_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_cancelled') ? 'is-invalid' : '' }}" type="number" name="is_cancelled" id="is_cancelled" value="{{ old('is_cancelled', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('cancelled_date_time') ? 'is-invalid' : '' }}" type="text" name="cancelled_date_time" id="cancelled_date_time" value="{{ old('cancelled_date_time') }}">
