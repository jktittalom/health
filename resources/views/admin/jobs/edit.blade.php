    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.jobs.update", [$job->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $job->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_description') ? 'is-invalid' : '' }}" type="text" name="job_description" id="job_description" value="{{ old('job_description', $job->job_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $job->start_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $job->end_time) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('job_type') ? 'is-invalid' : '' }}" name="job_type" id="job_type" required>
                    ...
                    @foreach(App\Models\Job::JOB_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('job_type', $job->job_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_hourly') ? 'is-invalid' : '' }}" type="number" name="is_hourly" id="is_hourly" value="{{ old('is_hourly', $job->is_hourly) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hour_rate') ? 'is-invalid' : '' }}" type="number" name="hour_rate" id="hour_rate" value="{{ old('hour_rate', $job->hour_rate) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_person_name') ? 'is-invalid' : '' }}" type="text" name="contact_person_name" id="contact_person_name" value="{{ old('contact_person_name', $job->contact_person_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_person_mobile') ? 'is-invalid' : '' }}" type="text" name="contact_person_mobile" id="contact_person_mobile" value="{{ old('contact_person_mobile', $job->contact_person_mobile) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_person_email') ? 'is-invalid' : '' }}" type="text" name="contact_person_email" id="contact_person_email" value="{{ old('contact_person_email', $job->contact_person_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('desigantion') ? 'is-invalid' : '' }}" type="text" name="desigantion" id="desigantion" value="{{ old('desigantion', $job->desigantion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attach_1') ? 'is-invalid' : '' }}" type="text" name="attach_1" id="attach_1" value="{{ old('attach_1', $job->attach_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attach_2') ? 'is-invalid' : '' }}" type="text" name="attach_2" id="attach_2" value="{{ old('attach_2', $job->attach_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget') ? 'is-invalid' : '' }}" type="text" name="budget" id="budget" value="{{ old('budget', $job->budget) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mall_practice') ? 'is-invalid' : '' }}" name="mall_practice" id="mall_practice">
                    ...
                    @foreach(App\Models\Job::MALL_PRACTICE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('mall_practice', $job->mall_practice) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('profile') ? 'is-invalid' : '' }}" name="profile_id" id="profile_id" required>
                    @foreach($profiles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('profile_id') ? old('profile_id') : $job->profile->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('facilities') ? 'is-invalid' : '' }}" name="facilities[]" id="facilities" multiple required>
                    @foreach($facilities as $id => $facility)
                        <option value="{{ $id }}" {{ (in_array($id, old('facilities', [])) || $job->facilities->contains($id)) ? 'selected' : '' }}>{{ $facility }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_salary') ? 'is-invalid' : '' }}" type="text" name="min_salary" id="min_salary" value="{{ old('min_salary', $job->min_salary) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_salart') ? 'is-invalid' : '' }}" type="text" name="max_salart" id="max_salart" value="{{ old('max_salart', $job->max_salart) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('over_time') ? 'is-invalid' : '' }}" type="text" name="over_time" id="over_time" value="{{ old('over_time', $job->over_time) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('call_required') ? 'is-invalid' : '' }}" name="call_required" id="call_required">
                    ...
                    @foreach(App\Models\Job::CALL_REQUIRED_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('call_required', $job->call_required) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('publish') ? 'is-invalid' : '' }}" name="publish" id="publish" required>
                    ...
                    @foreach(App\Models\Job::PUBLISH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('publish', $job->publish) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $job->notes) !!}</textarea>
                @if($errors->has('notes'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notes') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('travel_expense') ? 'is-invalid' : '' }}" name="travel_expense" id="travel_expense" required>
                    ...
                    @foreach(App\Models\Job::TRAVEL_EXPENSE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('travel_expense', $job->travel_expense) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('experiences') ? 'is-invalid' : '' }}" name="experiences[]" id="experiences" multiple required>
                    @foreach($experiences as $id => $experience)
                        <option value="{{ $id }}" {{ (in_array($id, old('experiences', [])) || $job->experiences->contains($id)) ? 'selected' : '' }}>{{ $experience }}</option>
                    @endforeach
                </select>
