    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscriptions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_trial') ? 'is-invalid' : '' }}" type="number" name="is_trial" id="is_trial" value="{{ old('is_trial', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_paid') ? 'is-invalid' : '' }}" type="number" name="is_paid" id="is_paid" value="{{ old('is_paid', '0') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_trial_expired') ? 'is-invalid' : '' }}" type="number" name="is_trial_expired" id="is_trial_expired" value="{{ old('is_trial_expired', '0') }}" step="1">
